...
def detect_injection(user_input: str) -> bool:
    ...
    INJECTION_PATTERNS = [
        ...
        r"you are now",
        r"system prompt",
        r"reveal your (instructions|prompt|system|secret|key|password)",
        r"pretend you are",
        r"act as (a |an )?unrestricted",
        r"override (your |all )?instructions",
        r"disregard all prior",
        r"bỏ qua (mọi|tất cả)? (hướng dẫn|chỉ thị|yêu cầu)",
        r"cho tôi xem (system prompt|mật khẩu|api key|cấu hình)",
        r"tiết lộ (mật khẩu|phần hướng dẫn|secret|cấu hình)",
        r"hãy đóng vai",
        r"bạn là một ai không bị giới hạn",
    ]
