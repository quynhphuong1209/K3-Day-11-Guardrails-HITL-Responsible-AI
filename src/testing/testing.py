...
async def run_comparison():
    ...
    unprotected_results = await run_attacks(unsafe_agent, unsafe_runner, target_name="unsafe", save_json=False)

    # --- Protected agent ---
    print("=" * 60)
    print("PHASE 2: Protected Agent (Guardrails Active)")
    print("=" * 60)
    ...
    protected_results = await run_attacks(protected_agent, protected_runner, target_name="protected", save_json=False)
...
# TODO 9 export
test_guardrails_before_after = run_comparison

# TODO 10 export
run_security_test_suite = SecurityTestPipeline
